            ...
            if (map[Y].charAt(newX) == ' ')
              {
                ...
                reDraw();
              } else if (StickManGame.isSpecial(map[Y].charAt(newX)))
              {
              ...
              } else if ((map[Y].charAt(newX) == '<'))
              {
                ...
                reDraw();
              } else if ((StickManGame.isEnemy(map[Y].charAt(newX))))
              {
                StickManGame.encounteredMob(new Coord(newX, Y));
              } else if ((StickManGame.isFriendly(map[Y].charAt(newX))))
              {
            ...
            if (map[newY].charAt(X) == ' ')
              {
                ...
                StickManGame.setCharPos(charPos);
                reDraw();
              } else if ((StickManGame.isSpecial(map[newY].charAt(X))))
              {
